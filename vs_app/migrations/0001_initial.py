# Generated by Django 3.0 on 2019-12-09 14:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AAVSOData',
            fields=[
                ('Name', models.CharField(max_length=33, primary_key=True, serialize=False)),
                ...
                ('MaxMag', models.CharField(blank=True, default=None, max_length=9, null=True)),
                ('MinMag', models.CharField(blank=True, default=None, max_length=9, null=True)),
                ('Discoverer', models.CharField(blank=True, default=None, max_length=256, null=True)),
        ...
        migrations.CreateModel(
            name='AstroMetryJob',
            fields=[
                ('job_number', models.PositiveIntegerField(primary_key=True, serialize=False)),
                ('url', models.URLField()),
        ...
        migrations.CreateModel(
            name='SimbadData',
            fields=[
                ('MAIN_ID', models.CharField(max_length=33, primary_key=True, serialize=False)),
                ('RA', models.FloatField()),
                ('DEC', models.FloatField()),
                ('RA_PREC', models.IntegerField(blank=True, default=None, null=True)),
                ('DEC_PREC', models.IntegerField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aavso_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='vs_app.AAVSOData')),
                ('astro_job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vs_app.AstroMetryJob')),
                ('simbad_data', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='vs_app.SimbadData')),
            ],
            options={
